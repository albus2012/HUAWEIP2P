...
void Connector::connect()
{
  ...
  cout << endl << "Connector::connect" << savedErrno << endl;
  switch (savedErrno)
  {
    case 0:
    case EINPROGRESS:
    ...
    case EFAULT:
    case ENOTSOCK:
      cout << "connect error in Connector::startInLoop " << savedErrno;
      sockets::close(sockfd);
      break;

    default:
      cout << "Unexpected error in Connector::startInLoop " << savedErrno;
      sockets::close(sockfd);
...
{
  cout << "Connector::handleWrite " << state_;
...
void Connector::retry(int sockfd)
{
  ...
  if (connect_)
  {
    cout << "Connector::retry - Retry connecting to " << serverAddr_.toIpPort()
